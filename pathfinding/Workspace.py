...
class Workspace:
    ...
    def heuristic_power(self, current_node, next_node, mission):
        ...
        target_labels = ml_model.predict(input_array)  # Assuming ml_model is defined somewhere

        power_watt = power(target_labels)  # Assuming power function is defined somewhere
